...
# ============================================================
# 八丁堀院 顧客満足度アンケート（神保町・横浜と同一設計・院別差分は2点のみ）
#   1) 書込先ワークシート: 'Hacchobori'（同一スプレッドシート内の八丁堀タブ）
#   2) Google口コミリンク : REVIEW_URL（八丁堀GBP公開後に確定）
...
def show_page_2():
    ...
    if REVIEW_URL:
        # 2026-08-15: 開院記念特典を &DR. BAKU へ変更（院内POPと同一内容）。
        # ⚠️ 八丁堀限定の特典。神保町・横浜・大宮のアプリは変更しない。
        st.write("★開院記念★ Googleクチコミのご投稿で、&DR. BAKU 1本プレゼント！")
